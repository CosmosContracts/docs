Pinning a code ID adds it to validators' cache, thus all contract using it. In effect, this removes startup fees associated with invoking contracts that use that code ID.
