...
{% file src="../.gitbook/assets/juno-logo-red- \(4\) \(3\) \(3\).svg" caption="JUNO LOGO \(Red\) SVG" %}
...
{% file src="../.gitbook/assets/juno-symbol \(2\) \(2\).svg" caption="JUNO Symbol Plain \(Black\) SVG" %}
...
![](../.gitbook/assets/juno-primary-color%20%281%29%20%281%29.png)
